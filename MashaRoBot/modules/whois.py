...
from MashaRoBot import dispatcher, OWNER_ID, DRAGONS, TIGERS, DEV_USERS, DEMONS, WOLVES
...
def info(bot: Bot, update: Update, args: List[str]):
    ...
    if user.id == OWNER_ID:
        text += "\n👑f,This person is my Owner🤴\nI would never do anything against him!."
        
    elif user.id in DEV_USERS:
        text += "\n🚴‍♂️,This person is my dev🤷‍♂️\nI would never do anything against him!."
        
    elif user.id == 1258905497:
        text += "\n👑,This person is my Creator🤷‍♂️\nI would never do anything against him!."     
