...
from pyrogramee.lockurl import add_chat, get_session, remove_chat
from pyrogramee.pluginhelpers import (
    admins_only,
    edit_or_reply,
    get_url,
    member_permissions,
    ...
    if lel:
        try:
            ...
            lol = await client.send_message(
                message.chat.id,
                f"{sender}, Your message was deleted as it contain a link(s).Links are not allowed‼️ here\nprotection by @Lovishmanager_bot",
            )
