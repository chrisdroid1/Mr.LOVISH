...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            "I'm awake already!\n<b>I AM WORKING SINCE:</b> <code>{}</code>".format(
                uptime
            ),
        ...
        if mod_match:
            ...
            query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🚴ɮǟƈӄ", callback_data="help_back")]]
                ),
            )
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ✨ I'm *LOVISH*, a powerful group management bot built to help you manage your group easily..\n\n•I can do lots of things in group.\n\n•I have feature of Ai chat..So i can talk like human👀\n\n•I have lots Music player in VC feature too🥰\n\n•ADD me into your Group and Make me Admin🙂and let me do my work...in your group\n   ~Thanks❤️~\n\nREPORT YOUR ISSUE TIPS FOR OUR BOT AT
                 Here is the [SUPPORT_CHAT](https://t.me/PsychoBots_Chat).
                 If you have any question about Lovish, let us know
                 CHECK BELOW HOW TO USE ME🙂""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="𝐻𝑜𝑤 𝑇𝑜 𝑈𝑠𝑒 𝑀𝑒?", callback_data="hw_to")
                  ]
                  [
                    InlineKeyboardButton(text="🧑‍🦼Ъαcк", callback_data="masha_back")
                   ]
                ]
            ),
        )
          ...
          parse_mode=ParseMode.MARKDOWN,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  ...
                  [
                    InlineKeyboardButton(text="◣𝗧&𝗖◥", callback_data="tc_menu"],
                ]]
            ),
         )
        ...
        query.message.edit_tex_text(text=f"•This Bot Lovish have Some terms and conditions"
          ...
          parse_mode=ParseMode.MARKDOWN,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                    InlineKeyboardButton(text="🧑‍🦽Ъacк", callback_data="hw_to")
                  ],
                  [ 
                    InlineKeyboardButton(text="•Ъαcк to MENU MAIN•", callback_data="masha_backk"),
                  ]
                ],
              )
    elif query.data == "masha_backk":
        query.message.edit_text(
                PM_START_TEXT,
                reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.MARKDOWN,
    ...
    if query.data == "source_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="🧑‍🦼Ъαcк", callback_data="source_back")
                 ]
                ]
            ),
        )
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Lovish is restarted and on fire 🍂now")
        except Unauthorized:
            LOGGER.warning(
