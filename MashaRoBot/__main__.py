        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [ 
                    InlineKeyboardButton(
                            text="𝐻𝑜𝑤 𝑇𝑜 𝑈𝑠𝑒 𝑀𝑒?", callback_data="use_menu")
                 ],
               ]
            )
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  ...
                  [InlineKeyboardButton(text="◣𝗧&𝗖◥", callback_data="tu_menu")
                      ],
                    ]
                  )
    elif query.data == "tu_menu":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
              [
                [
                  InlineKeyboardButton(text="🧑‍🦽Ъacк", callback_data="use_menu")
                ],
                [
                  InlineKeyboardButton(text="•ᴍᴇɴᴜ ᴍᴀɪɴ•", callback_data="masha_")
                ]
              ],
            )
