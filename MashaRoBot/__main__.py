...
"""
TC = """
This BOT HAVE SOME Terms& Condition\n
...
def Masha_about_callback(update: Update, context: CallbackContext):
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    ...
                    InlineKeyboardButton(text="◣𝗧&𝗖◥", callback_data="_block")],
                  ]
               ),
            )
    ...
    elif query.data == "_block":
        query.message.edit_text(
                TC,
                reply_markup=InlineKeyboardMarkup(
                   [
                    [
                    InlineKeyboardButton(text="🧑‍🦼Ъαcк", callback_data="masha_")]
                    ]
                 ),
               )
